...
* [IBM Cloud account](generatedContent/workshop-setup/NEWACCOUNT/),
* [Connect to Red Hat OpenShift Kubernetes Service (ROKS)](generatedContent/workshop-setup/ROKS/),
...
Once your cluster and client is configured, you are ready to deploy your first application, `guestbook`.
